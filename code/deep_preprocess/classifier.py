...
from utils.exceptions import InvalidArchitectureException
...
class Classifier:
    ...
    def __init__(self, architecture='inception', n_features=2048, weights='imagenet'):
        self.architecture = architecture
        self.n_features = n_features

        m, preprocessing_fn = self._get_architecture(architecture)
        base_model = m(weights=weights, include_top=False)
        ...
        self.model = Model(input=base_model.input, output=out)
